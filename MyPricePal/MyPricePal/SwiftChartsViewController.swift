...
class SwiftsChartsViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        let chart = BarsChart(frame: frame, chartConfig: chartConfig, xTitle: "User Actions Within App", yTitle: "Number", bars: [                                                                             ("Scanned",return_products_scanned()),("URL's Clicked",return_url()),("Inputed",return_products_added()),],
