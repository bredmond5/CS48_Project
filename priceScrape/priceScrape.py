...
while True:
    ...
    Config = {
                "apiKey": "AIzaSyD6wZtZ5JLQS5_MFMbZXovbLrbTxXUiDf8",
                "authDomain": "cs48-mypricepal.firebaseapp.com",
                "databaseURL": "https://cs48-mypricepal.firebaseio.com",
                "projectId": "cs48-mypricepal",
                "storageBucket": "cs48-mypricepal.appspot.com",
                "messagingSenderId": "261764384449",
                "appId": "1:261764384449:web:0eab9a6b6eb172ab"
            }
    ...
    check = db.child("PythonScript").child("FunctionCall").get().val()
    
    print(check)
    
    if( check == 1):
        # product = input("Please enter the product: ")
        product = db.child("PythonScript").child("itemName").get().val()
        ...
        time.sleep(2)
         ...
         if(page_soup.select("[type='application/json']")[2]):
        ...
        db.child("PythonScript").child("JSON").update(data)
        db.child("PythonScript").update({"FunctionCall":0})